...
void compute_influence_coefficients_vor4(double *grid,double *panels, double *colloc,double *te_idx,double *colloc_nvec,double *w,double *w_x,double *w_y,double *w_z,mwSize n_colloc,double * Uinf)
{
    mwSize i,j,count=0;
        ...
        for (j=0;j<n_colloc;j++){
            ...
            for (i=0;i<5;i++){
                ...
                if  ( (!((normr1<=1E-7)||(normr2<=1E-7))) && coredist>1E-7)
                {
                    ...
                    if (i!=2){
                        wAB_1i=wAB_1i-r1xr2_1/(norm_r1xr2*norm_r1xr2)*dotp_r0_r1dr2;
                        wAB_2i=wAB_2i-r1xr2_2/(norm_r1xr2*norm_r1xr2)*dotp_r0_r1dr2;
                        wAB_3i=wAB_3i-r1xr2_3/(norm_r1xr2*norm_r1xr2)*dotp_r0_r1dr2;
                    }
                }
            }
        ...
        int nrhs, const mxArray *prhs[])
{
 ...
 /* ncols = mxGetN(prhs[0]);
  ...
  /*  set the output pointer to the output matrix */
    ...
    compute_influence_coefficients_vor4(grid,panels,colloc,te_idx,colloc_nvec,w,w_x,w_y,w_z,n_colloc,Uinf);
