...
%
function [aircraft,flight_state,wingaero ] = trim_aircraft_faster(aircraft,flight_state,wingaero,def)
...
fprintf('final: CM= %f, elev=%f, alpha=%f\n',wingaero.CM+delta_CM,elev, wingaero.state.alpha);
%wingaero=wingaero.f_solve_full();
