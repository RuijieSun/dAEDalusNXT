...
function obj = elq_6dof_anisotropic(obj,add_eigenmass,add_fuelmass)
...
%     end
    ...
    obj.elq=([qx*le/2+0.15*obj.dqx*le^2,...
               qy*le/2+0.15*obj.dqy*le^2,...
               qz*le/2+0.15*obj.dqz*le^2,...   
               mx*le/2+0.15*obj.dmx*le^2+qz*le^2/12+fract*obj.dqz*le^3,...
               mt*le/2+0.15*obj.dmt*le^2,...
               mz*le/2+0.15*obj.dmz*le^2-qx*le^2/12-fract*obj.dqx*le^3,...    
              (qx+obj.dqx)*le/2-0.15*obj.dqx*le^2,...
              (qy+obj.dqy)*le/2-0.15*obj.dqy*le^2,...
              (qz+obj.dqz)*le/2-0.15*obj.dqz*le^2,...     
              (mx+obj.dmx)*le/2-0.15*obj.dmx*le^2-(qz+obj.dqz)*le^2/12-fract*obj.dqz*le^3,...
              (mt+obj.dmt)*le/2-0.15*obj.dmt*le^2,...
              (mz+obj.dmz)*le/2+0.15*obj.dmz*le^2+(qx+obj.dqx)*le^2/12+fract*obj.dqx*le^3])';
...
%                 mt*le/2+0.15*obj.dmt*le^2,...
%                 mx*le/2+0.15*obj.dmx*le^2-qz*le^2/12-fract*obj.dqz*le^3,...
%                 mz*le/2+0.15*obj.dmz*le^2+qy*le^2/12+fract*obj.dqy*le^3,...    
%                 (qx+obj.dqx)*le/2-0.15*obj.dqx*le^2,...
%                 (qy+obj.dqy)*le/2-0.15*obj.dqy*le^2,...
%                 (qz+obj.dqz)*le/2-0.15*obj.dqz*le^2,...     
%                 (mt+obj.dmt)*le/2-0.15*obj.dmt*le^2,...
%                 (mx+obj.dmx)*le/2-0.15*obj.dmx*le^2+(qz+obj.dqz)*le^2/12+fract*obj.dqz*le^3,...
%                 (mz+obj.dmz)*le/2+0.15*obj.dmz*le^2-(qy+obj.dqy)*le^2/12-fract*obj.dqy*le^3])';
