...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % =================================================================
        %> @brief assemble system stiffness matrix and load vector from
        %> element matrices
        %>
...
function obj = f_assemble(obj,add_eigenmass,add_fuelmass,add_engineforces,add_gearforces)
    ...
    if obj.update_M==1
        if ~obj.isExternalFEM
             ...
             k=1; %counter
             obj.M_lumped=zeros(size(obj.M_lumped,1),size(obj.M_lumped,2));
             for i=1:obj.nel  
                %Assemble System mass Matrix
        ...
        %add concentrated masses if existing
