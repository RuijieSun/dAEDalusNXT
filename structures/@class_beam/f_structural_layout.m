...
%             QZ=Qz(i)*0.25+Qz(i+1)*0.25+Qz(end-i+1)*0.25+Qz(end-i)*0.25;
            ...
            %Simon: besser: jeweils höhere Lasten, entweder re oder li
        ...
        elseif isa(obj,'class_pylon')
                obj.beamelement(i).Iz=1;
                obj.beamelement(i).Ix=1;
                obj.beamelement(i).Ip=1;
                obj.beamelement(i).J=1;
                obj.beamelement(i).A=1;
